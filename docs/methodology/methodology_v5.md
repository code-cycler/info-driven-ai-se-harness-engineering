...
> **(v5/v6/v7 安全科学注)** 护栏的深层根基是安全科学——安全 = 系统级控制(STAMP,Leveson);工程纪律让劣化「可被看见、被拦截」即**控制可见**,是对抗 AI 黑盒(过程不可见)的装置。详见 [哲学 §三](philosophy_v7.md#四安全科学视角去-ai-黑盒)。
...
18. **盲信 AI 替代工程纪律 / 黑盒信任劫持** ★ — 跳过测试/设计/审查;黑盒场景(过程不可见)尤其易盲信。预防:AI × 软件工程,纪律是骨架(见 §1.2-2.3);黑盒场景强制留痕(见 [哲学 §三](philosophy_v7.md#四安全科学视角去-ai-黑盒))。
...
| 信息断层(单一叙述)             | **两类信息断层**                   | 细化         | 人与人断层 → AI 替代角色(见 [§1.2](philosophy_v7.md#12-ai-替代的传统角色));人与 AI 断层 → 问答对齐(§5)。见 [§1.2](philosophy_v7.md#12-两类信息断层)               |
...
| 四.5、决策下放                     | v1 §6.5 决策分层最底层 + delegate skill 试点                                                                     |
