...
- **单点深钻族**(grill / grill-with-docs)=依赖链深、决策未成形、需即时反馈或必须绑定现实证据的关键问题层。
...
九个 skill 的共同契约只约束五件事:输入 / 输出、证据状态、偏差记录、验证强度、交接触发。它们解决的是生态位可见性和责任可追溯,不是新增第十个总控权威。唯一权威路由表与覆盖矩阵由 [方法论文件 §3.3.1](methodology_v5.md#331-skill-生态位路由与跨-skill-最小契约v7-w02) 和 [治理最小切片](../../harness/design/methodology-governance/LLD.md) 承载。
