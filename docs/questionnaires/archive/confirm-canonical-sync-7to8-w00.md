...
**下一波候选**(未在本行动执行,备查):① CLAUDE.md 落盘路径速查表缺 action-Q 行(确认范围未含);② 全局 `~/.claude/CLAUDE.md`「Grill 类 skill 触发边界」表缺 action-Q(条目 13 确认默认不动,如后续想补需显式要求);③ v3 正文 §4.2 是否展开 action-Q 机制论述(条目 14 确认本次不扩写)。
